...
export default ({ hideFunction, submitFunction, feedbackIsPositive=false }) => {
  return (
    <div
      css={css`
        top: 0;
    ...
    >
      <div
        ...
        `}
      >
        {feedbackIsPositive? 'Please tell us what you liked' : 'Please tell us how we could improve'}
      </div>
      <div
        css={css`
          flex-grow: 1;
